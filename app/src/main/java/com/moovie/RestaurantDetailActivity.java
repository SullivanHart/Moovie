...
public class RestaurantDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab_show_rating_dialog).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.restaurant_button_back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    // Back arrow clicked event handler
    public void onBackArrowClicked(View view) {
        onBackPressed();
    }

    // Add rating button clicked event handler
